    ...
    <div class="container center">
        ...
        <div class="row">
            <div class="col m4 s4 l4" style="border-style: solid;border-color:gray;border-width: 1px;border-right-style:none;height: 100px;padding-left: 0px;border-top-style:none">
                <br><img src="../img/logo_semillias.svg" style="width: 230px;height: 60px">
            </div>
        ...
        <div class="row" style="padding-bottom: 20px;padding-left: 10px;padding-right: 10px;margin-bottom: 0px;">
            <br><button class="btn"  id= "Btn1" onclick="Consultar()" style="color:white;background:#1e88e5">GUARDAR</button>
        </div>
